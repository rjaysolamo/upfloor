...
CREATE TABLE IF NOT EXISTS collections (
    ...
    royalty_percentage DECIMAL(5,2) NOT NULL DEFAULT 0.00, -- Royalty percentage (e.g., 3.00 for 3%)
    ...
    -- Owned NFTs tracking (optional)
    owned_nfts JSONB DEFAULT '[]'::jsonb, -- Array of owned NFT data (tokenId, purchasedAt, marketplace)
